...
namespace AutoCow
{
    public partial class MLModel1
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Milk_Production_LB")]
            public float[] Milk_Production_LB { get; set; }

            [ColumnName(@"Milk_Production_UB")]
            public float[] Milk_Production_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"C:\Users\Lenovo\source\repos\AutoCow\AutoCow\Models\MLModel1.zip");
